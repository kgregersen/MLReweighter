...
void Plot8(TString inFileTrain, TString inFileTest, TString sourceName, TString targetName, TString eventWeightName, TString MLWeightName, TString label, TString nLayers, TString nEvents, TString variable, int nBins, float xMin, float xMax)
{
  ...
  tex.DrawLatex(0.16, 0.75, "Max layers");
  tex.DrawLatex(0.23, 0.75, ":");
  tex.DrawLatex(0.25, 0.75, nLayers);
  tex.DrawLatex(0.16, 0.71, "Min events");
  tex.DrawLatex(0.23, 0.71, ":");
  tex.DrawLatex(0.25, 0.71, nEvents);
  ...
  c->SaveAs( TString::Format("%s/%s_%s__nLayers%s_nEvents%s___LinScale.pdf", directory.Data(), MLWeightName.Data(), variable.Data(), nLayers.Data(), nEvents.Data()) );
  c->SaveAs( TString::Format("%s/%s_%s__nLayers%s_nEvents%s__LinScale.eps", directory.Data(), MLWeightName.Data(), variable.Data(), nLayers.Data(), nEvents.Data()) );
  
  frame1->SetMaximum(hT->GetMaximum()*5000.);
  p1->SetLogy();
  c->SaveAs( TString::Format("%s/%s_%s__nLayers%s_nEvents%s__LogScale.pdf", directory.Data(), MLWeightName.Data(), variable.Data(), nLayers.Data(), nEvents.Data()) );
  c->SaveAs( TString::Format("%s/%s_%s__nLayers%s_nEvents%s__LogScale.eps", directory.Data(), MLWeightName.Data(), variable.Data(), nLayers.Data(), nEvents.Data()) );
